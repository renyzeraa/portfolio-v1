      ...
      <main className='main-container'>
        ...
        <div className='container'>
          <div className="text-area">
            <Text>Prazer sou Renan Silva👋🏻, um desenvolvedor full-stack apaixonado pela criação de interfaces web incríveis. Com 25 anos de idade e uma paixão ardente pela tecnologia, tenho 2 anos de experiência na área 👨🏻‍💻. Estou focado em aprimorar minhas habilidades tanto no front-end quanto no back-end.</Text>
